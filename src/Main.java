...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Dragon set up
        Dragon[] dragons = createDragons();


        //Start the battle until all dragons are dead

        boolean heroWins = runBattle(hero, dragons);

        //Battle outcome

        printBattleOutcome(heroWins, dragons);
    ...
    private static boolean runBattle(Hero hero, Dragon[] dragons) {
    ...
    private static Dragon[] createDragons() {
    ...
    private static void printBattleOutcome(boolean heroWins, Dragon[] dragons) {
