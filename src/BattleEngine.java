...
public class BattleEngine {
    ...
    public static void dragonsAttackHero(Dragon[] dragons, Hero hero) {
    ...
    public static void printDragonStatus(Dragon[] dragons) {
    ...
    public static boolean runBattle(Hero hero, Dragon[] dragons) {
    ...
    public static void printBattleOutcome(boolean heroWins, Dragon[] dragons) {
